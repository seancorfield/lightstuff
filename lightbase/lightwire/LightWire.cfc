<cfcomponent output="false" hint="I am the LightWire factory that creates all singleton and transient objects, injecting them with all of their necessary dependencies as defined in the configuration file.">
...
<cffunction name="init" returntype="LightWire" access="public" output="true" hint="I initialize the LightWire object factory.">
	...
	<cfscript>
		...
		variables.BaseClassPath = "";
		variables.LazyLoad = ConfigBean.getLazyLoad();
		variables.config = ConfigBean.getConfigStruct();
		variables.Singleton.LightWire = THIS;
		If (NOT variables.LazyLoad)
   		{
...
<cffunction name="hasBean" returntype="any" access="public" output="false">
	<cfargument name="ObjectName" type="string" required="yes">
	<cfscript>
		if (structKeyExists( variables.Config , ObjectName)) {return true;}
		else { return false; };
	</cfscript>
</cffunction>
...
<cffunction name="createNewObject" returntype="any" access="private" output="false" hint="I create a object.">
	...
	<cfscript>
		...
		If (StructKeyExists(variables.Config[arguments.ObjectName], "Path"))
		{
			...
			If (Len(variables.BaseClassPath) GT 0)
				ObjectPath = variables.BaseClassPath & "." & ObjectPath;
...
<cffunction name="setterandMixinInject" returntype="any" access="private" output="false" hint="I handle.">
	...
	<cfscript>
		...
		// Always Mixin LightWire Factory as both LightWire and BeanFactory (LightWire deprecated)
		arguments.object.lightwireMixin("LightWire", variables.singleton.LightWire);			
		arguments.object.lightwireMixin("beanFactory", variables.singleton.LightWire);			
...
<cffunction name="throw" returntype="void" hint="I throw an error." output="false">
	...
	<cfthrow message="LIGHTWIRE ERROR: #ErrorMessage#">
</cffunction>
